// src/components/admin/sales/salesHelpers.jsx
//
// Small, stateless UI primitives shared across Sales sub-components.

import { labelStyle } from "../shared/adminStyles";

// ─── Error helpers ─────────────────────────────────────────────
// Exported as functions so SaleFormFields, LineItemsView, and any future
// sub-component can import once — no re-definition per file needed.
// Purchase defines these as local closures inside each form file; exporting
// them here is one step better — single definition, used everywhere.
